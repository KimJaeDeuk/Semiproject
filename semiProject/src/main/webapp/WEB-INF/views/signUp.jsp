					...
					<div class="col-lg-6 col-md-6">
						<div class="login_part_form">
							<div class="login_part_form_iner">
								...
								<form class="row contact_form" action="createAccount.do" method="post" novalidate="novalidate">
									<div class="container">
										<div class="input-form-backgroud row">
											<div class="input-form col-md-12 mx-auto">
												<h4 class="mb-3">회원가입</h4>
													...
													<div class="mb-3">
														<label for="customerPass">비밀번호</label><input
															type="password" class="form-control" id="customerPass"
															name="customerPass" placeholder="" value="" required>
													</div>
													<div class="mb-3">
														<label for="passCheck">비밀번호 확인</label> <input
															type="password" class="form-control" id="passCheck"
															placeholder="" required>
														<span id="ckPassCk" class='check'>비밀번호가 같지 않습니다.</span>
													</div>
													<div class="mb-3">
														<label for="customerName">이름</label> <input
															type="text" class="form-control" id="customerName"
															name="customerName" placeholder="" required>
													...
													<div class="row">
														...
														__
														<div class="col md-6 mb-3">
															<input type="text" class="form-control" id="customerRrn2"
																name="customerRrn2" placeholder="" required>
													...
													<div class="row">
														<div class="col md-3 mb-3">
															<input type="text" class="form-control" id="customerTel1"
																name="customerTel1" placeholder="" required>
														</div>
														__
														<div class="col md-3 mb-3">
													...
													<div class="row">
														<div class="col md-6 mb-3">
															<input type="text" id="customerAddr1" name="customerAddr1"
													...
													<div class="mb-3">
														<input type="text" id="customerAddr2" name="customerAddr2"
															class="form-control" placeholder="주소">
													</div>
													<div class="row">
														<span id="guide" style="color: #999; display: none"></span>
														<div class="col md-6 mb-3">
															<input type="text" id="customerAddr3" name="customerAddr3"
													...
													<button class="btn btn-primary btn-lg btn-block"
														type="submit" id="confirm">가입 완료</button>
			...
			new daum.Postcode(
					{
						oncomplete : function(data) {
							...
							document.getElementById('customerAddr1').value = data.zonecode;
							document.getElementById("customerAddr2").value = addr;
							// 커서를 상세주소 필드로 이동한다.
							document.getElementById("customerAddr3")
									.focus();
						}
					}).open();
		}
